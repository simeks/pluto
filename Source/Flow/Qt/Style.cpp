...
const FlowUIStyle& FlowUIStyle::default_style()
{
    if (!s_default)
    {
        ...
        s_default->grid_color_1 = QColor::fromRgb(100, 100, 100);

        s_default->link_color = QColor::fromRgb(180, 180, 180);
        s_default->link_color_selected = QColor::fromRgb(255, 255, 255);

        s_default->node_background = QColor::fromRgb(62, 62, 62);
        s_default->node_border = QColor::fromRgb(20, 20, 20);
        s_default->node_border_selected = QColor::fromRgb(100, 100, 100);
        ...
        s_default->pin_outline_color = QColor::fromRgb(100, 100, 100);
        s_default->pin_color_highlight = QColor::fromRgb(255, 255, 255);
        s_default->pin_outline_color_highlight = QColor::fromRgb(100, 100, 100);
